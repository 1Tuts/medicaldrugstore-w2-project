...
<title><?php echo $lang->line('common_authentication');?></title>
...
<div id="content-outer">
	<div id="content">
		...
		<li><?php echo $lang->line('common_authentication');?></li>
		</ul>
		<br/>
		<div id="page-heading">
			<h1><?php echo $lang->line('common_authentication');?></h1>
		</div>
...
<td  width="50%" style="text-align: left;"><a href="change_user_list.php"><?php echo $lang->line('common_users_caps');?></a></td>
<?php } else {?>
...
<td width="25%"><a href="add_user.php" title="<?php echo $lang->line('common_create_users');?>"><img src="../assets/images/plus_16.png" alt="<?php echo $lang->line('common_create_img_alt');?>"></a></td>
<?php } else {?>
<td width="25%"><img src="../assets/images/plus_16.png" alt="<?php echo $lang->line('common_create_img_alt');?>"></td>
<?php }?>
<?php if($admin->does_user_have_access('change_page_sadmin_users', 'auth')){?>
<td width="25%"><a href="change_user_list.php" title="<?php echo $lang->line('common_edit_users');?>"><img src="../assets/images/pencil_16.png" alt="<?php echo $lang->line('common_edit_img_alt');?>"></a></td>
<?php } else {?>
...
<td style="text-align: left;"><a href="change_role_list.php"><?php echo $lang->line('common_roles_caps');?></a></td>
<?php } else {?>
...
<td width="25%"><a href="add_role.php" title="<?php echo $lang->line('common_create_roles');?>"><img src="../assets/images/plus_16.png" alt="<?php echo $lang->line('common_create_img_alt');?>"></a></td>
<?php } else {?>
<td width="25%"><img src="../assets/images/plus_16.png" alt="<?php echo $lang->line('common_create_img_alt');?>"></td>
<?php }?>
<?php if($admin->does_user_have_access('change_page_sadmin_roles', 'auth')){?>
<td width="25%"><a href="change_role_list.php" title="<?php echo $lang->line('common_edit_roles');?>"><img src="../assets/images/pencil_16.png" alt="<?php echo $lang->line('common_edit_img_alt');?>"></a></td>
<?php } else {?>
<td width="25%"><img src="../assets/images/pencil_16.png" alt="<?php echo $lang->line('common_edit_img_alt');?>"></td>
<?php }?>
</tr>
...
<td style="text-align: left;"><a href="change_perm_list.php"><?php echo $lang->line('common_permissions_caps');?></a></td>
<?php } else {?>
...
<td width="25%"><a href="add_perm.php" title="<?php echo $lang->line('common_create_permissions');?>"><img src="../assets/images/plus_16.png" alt="<?php echo $lang->line('common_create_img_alt');?>"></a></td>
<?php } else {?>
<td width="25%"><img src="../assets/images/plus_16.png" alt="<?php echo $lang->line('common_create_img_alt');?>"></td>
<?php }?>
<?php if($admin->does_user_have_access('change_page_sadmin_permissions', 'auth')){?>
<td width="25%"><a href="change_perm_list.php" title="<?php echo $lang->line('common_edit_permissions');?>"><img src="../assets/images/pencil_16.png" alt="<?php echo $lang->line('common_edit_img_alt');?>"></a></td>
<?php } else {?>
<td width="25%"><img src="../assets/images/pencil_16.png" alt="<?php echo $lang->line('common_edit_img_alt');?>"></td>
<?php }?>
</tr>
