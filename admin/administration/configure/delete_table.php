...
if(!$admin->does_user_have_access('delete_page_sadmin_config_table', 'config')){
	header('Location: ../access_denied.php');
	exit;
}
...
if(isset($_POST['delete_confirm'])){
	$admin->delete_table_permissions($table_id);
	$admin->delete_table_fields($table_id);
	$success = $admin->delete_config_table($table_id);
	if(!$success)
		$error .= $lang->line('auth_config_table_delete_error');
}
?>
...
<title><?php echo $lang->line('auth_config_delete_table_title');?></title>
...
<div id="content-outer">
	<div id="content">
		...
		<li><?php echo $lang->line('auth_config_delete_table_title');?></li>
		</ul>
		<br/>
		<div id="page-heading">
			<h1><?php echo $lang->line('auth_config_delete_table_title');?></h1>
		</div>
...
if($success)
	echo '<p class="valid_box">' . $lang->line('auth_config_table_delete_success') . '</p><div class="clear"></div>';
?>
<form method="post" action="delete_table.php?table_id=<?php echo $table_id;?>" name="delete_form" id="delete_form">
<p><?php echo $lang->line('auth_config_table_delete_confirm');?></p>
<br/>
